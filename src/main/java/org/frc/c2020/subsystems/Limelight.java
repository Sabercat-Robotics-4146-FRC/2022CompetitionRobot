...
public class Limelight implements Subsystem {
  ...
  public double ballSpeed = 3; //TODO: Calculate the exit speed of the ball in meters per second, set this to said value.

  public double Kp = -0.1;

  public double minCommand = 0.05;

  public double cameraAng = 10 * (Math.PI/180); //TODO: calculate the angle the limelight is at, set this to that angle.
  ...
  public double calculateShootingAngle() {
    ...
    double s = ballSpeed;
    //This calculation may return nan if the radicand is less than 0. This means the shot is impossible.
    double theta = Math.atan((s*s + Math.sqrt(s*s*s*s - g*(g*x*x + 2*y*s*s)))/(g*x));
  ...
  public double calculateServoPosition() {
    ...
    //TODO: Roughly measured initial and final arc points from cad file, if performance is poor, remeasure these points
    ...
    double extension = arcLength/ m / maxExtension;
