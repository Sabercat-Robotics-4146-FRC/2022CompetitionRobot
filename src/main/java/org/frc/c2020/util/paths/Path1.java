package org.frc.c2020.util.paths;
...
import org.frc.common.control.TrajectoryConstraint;
...
public class Path1 extends CommandGroup {
    ...
    public void loadTrajectory() {
        ...
        try {
          ...
          path = reader.read();
          trajectory1 = new Trajectory(path, new TrajectoryConstraint[] {new TrajectoryConstraint(){}}, 10);

          reader = new PathReader(new FileReader(trajectoryJSON1));
          path = reader.read();
          trajectory2 = new Trajectory(path, new TrajectoryConstraint[] {new TrajectoryConstraint(){}}, 10);
