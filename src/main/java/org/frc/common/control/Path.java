...
import org.frc.common.util.InterpolatingTreeMap;

public class Path {
  private final PathSegment[] segments;
  private final InterpolatingTreeMap<InterpolatingDouble, Rotation2> rotationMap =
  ...
  public Path(PathSegment[] segments, Map<Double, Rotation2> rotationMap) {
    ...
    for (Map.Entry<Double, Rotation2> rotationEntry : rotationMap.entrySet()) {
      this.rotationMap.put(
          new InterpolatingDouble(rotationEntry.getKey()), rotationEntry.getValue());
    }
