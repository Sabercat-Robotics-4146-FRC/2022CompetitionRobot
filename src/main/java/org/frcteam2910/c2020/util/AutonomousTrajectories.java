...
public class AutonomousTrajectories {
    ...
    public AutonomousTrajectories(TrajectoryConstraint[] trajectoryConstraints) throws IOException {
        ...
        slowConstraints[slowConstraints.length - 1] = new MaxVelocityConstraint(6.0 * 12.0); // change this to lower speed
        slowConstraints[slowConstraints.length - 2] = new MaxAccelerationConstraint(4.0 * 12.0); // change this to lower acceleration
        ...
        straightAutoPartOne = new Trajectory(
                new SimplePathBuilder(Vector2.ZERO, Rotation2.ZERO)
