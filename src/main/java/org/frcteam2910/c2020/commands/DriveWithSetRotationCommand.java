...
public class DriveWithSetRotationCommand extends CommandBase {
  ...
  public DriveWithSetRotationCommand(
      DrivetrainSubsystem drivetrain, Axis forward, Axis strafe, double setRotation) {
  ...
  public void execute() {
    double rotationOutput =
        rotationController.calculate(drivetrain.getPose().rotation.toRadians(), 0.02);
